...
use super::Backend;
use crate::parser::{Config, TableSpec, ColumnSpec};
...
impl Backend for PrismaBackend {
    ...
    fn generate(&self, cfg: &Config) -> Result<String> {
        ...
        // Minimal header suitable for Postgres
        out.push_str("// Generated by dbschema (tables → Prisma)\n");
...
fn render_model(t: &TableSpec) -> String {
...
fn render_field(c: &ColumnSpec, t: &TableSpec) -> String {
    let mut parts: Vec<String> = Vec::new();
    // name
    parts.push(c.name.clone());
    // type + nullability
    let (ptype, db_attr) = prisma_type(&c.r#type);
